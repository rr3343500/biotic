...
public class Piechart  extends View {
    ...
    private Piechart.OnPieClickListener onPieClickListener;
    ...
    public void setDate(ArrayList<PiechartHelper> helperList) {
       initPies(helperList);
        ...
        if (helperList != null && !helperList.isEmpty()) {
         for (PiechartHelper piechartHelper : helperList){
             pieHelperList.add(new PiechartHelper(piechartHelper.getStartDegree(),piechartHelper.getEndDegree(),piechartHelper));
         }
